<template>
    <!-- Korišten je v-col zato što se ova komponenta ugniježđuje u v-row -->
    <v-col cols="12" sm="6" md="6" lg="4" xl="3">
        <v-card max-width="374" min-width="160" class="mx-auto">
            <v-card-text>
                <v-row align="center">
                    <v-col cols="6">
                    <v-img
            ...
            <v-card-title>
                Široki Brijeg - Genova
            </v-card-title>
            <v-card-subtitle>
                Raspoloživo: 7 m<sup>3</sup>, 10 t
            </v-card-subtitle>
            <v-card-text>
